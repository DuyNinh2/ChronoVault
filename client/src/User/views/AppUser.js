...
const AppUser = () => {
    ...
    const noHeaderFooterRoutes = ['/', '/login', '/create-account', '/forgot-password', '/admin-system', '/product-management', '/order-management', '/promotion-management', '/user-management', '/statistics-management'];
    const HeaderRoutes = ['/'];
